...
**OK, Fredrik, hur hittar vi ett bra och säkert casino då?**
Lita inte på någon "lista" (jag har försökt ge dig de bästa och säkraste sajterna i min lista ovan, jag har varit i den här branschen i över 10 år och förstår en hel del). Gör din egen verifiering.
...
Ett casino (B2C) är bara en "butik". Spelen (B2B) tillverkas av andra företag.
...
2. **Din uppgift:** Gå till spelbiblioteket. Ser du logotyperna för etablerade spelleverantörer (Pragmatic, NetEnt, osv)? Det är ett starkt tecken på att spelen är rättvisa och granskade. Om du, å andra sidan, bara ser **okända** leverantörer, borde du vara försiktig. ![Pragmatic Play](/images/image3.png) ![Mer etablerade spelleverantörer](/images/image4.png)
...
**🚨** Det är mestadels via sjuka bonusvillkor som dåliga sajter lurar dig. Bonusar som erbjuds på casinon utan svensk licens är enorma, men de är ofta fyllda med fällor för att du aldrig ska kunna ta ut dina pengar: ![Lusläsning av bonusvillkor](/images/image2.gif)
Du måste kontrollera 3 saker under casinots bonusvillkor:

**Beräkning av omsättningskrav:** När du får en casinobonus står det nästan alltid ett omsättningskrav, till exempel 30x. Det betyder att du måste spela ("omsätta") en viss summa pengar innan du får ta ut vinster från bonusen. Men, det viktiga är vad multiplikatorn gäller för. Det finns två vanliga sätt casinon räknar på:

   - **Alternativ 1:** Endast bonusen (B) räknas. Kravet gäller bara på själva bonusbeloppet. Detta är den vanligaste och mest rättvisa metoden. **Exempel:** Du sätter in 100 €, får 100 € i bonus, omsättningskrav 30x bonusen. Beräkning: 30 × 100 € = 3 000 € måste omsättas (Du behöver alltså spela för totalt 3 000 € innan du kan ta ut vinsterna.)

   - **Alternativ 2:** Insättning + bonus (I + B) räknas. Omsättningskravet gäller på både insättningen och bonusen. Det gör bonusen betydligt svårare att omsätta. **Exempel:** Du sätter in 100 €, får 100 € i bonus, omsättningskrav 30x (insättning + bonus). Beräkning: 30 × (100 € + 100 €) = 6 000 € måste omsättas. Det är alltså dubbelt så högt omsättningskrav som i det första exemplet.

**Spelbidrag:** Spelar du Blackjack? Otur för dig då dina insatser räknas troligen inte. Nästan alltid så tvingas du till en av följande för att kunna ta del av bonusen:
   - **Spelautomater (slots):** Vanligtvis kan 100% av det du spelar här räknas mot omsättningskravet.
   - **Brädspel (Blackjack, Roulette):** Ungefär 5-10% eller till och med 0%. Detta innebär att kravet på 3.000 € i praktiken blir ett krav på 30.000 € om du spelar Blackjack med 10% bidrag då 100% av det du spelar för räknas inte mot omsättningskravet.

**De Dolda Fällorna:**
   - **"Max Bet" (maximal insats):** Detta är den värsta fällan. Nästan alla bonusar förbjuder insatser över ett visst belopp (vanligtvis 5 €) när du spelar för bonusen. Om du satsar 5.10 € en enda gång, även av misstag, kommer de att annullera alla dina bonusvinster. Det är den vanligaste ursäkten för att inte betala ut.
   - **"Max Cashout" (maximalt uttag):** Vanligt på gratissnurr (free spins). Vilket betyder att casinot har satt en gräns för hur mycket du kan ta ut i vinst från en bonus.
   - **Uteslutna spel:** Var vaksam över att just det spelet du har valt ingår och kan räknas gentemot omsättningskravet för annars kan du ha spenderat en jäkla massa pengar men ser sedan att just det spelet är utesluten från din bonus. Det brukar oftast vara slots med hög RTP (som Blood Suckers). Dubbelkolla detta innan du sätter igång.
